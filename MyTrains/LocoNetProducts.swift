...
public typealias LocoNetProduct = (id: LocoNetProductId, productName: String, description: String, approxDate: Int, productCode: ProductCode, attributes: LocoNetDeviceAttributes, sensors: Int, switches: Int, manufacturer:Manufacturer, cvs: Int)
