...
public class LocoNetProducts {
  ...
  private static let products : [LocoNetProduct] = [
    ...
    (.DB100, "DB100", "5 Amp DCC Booster with Auto Reversing", 1993, .none, [.Booster], 0, 0),
    (.DB100PLUS, "DB100+", "5 Amp DCC Booster with Auto Reversing", 1993, .none, [.Booster], 0, 0),
    (.DB100A, "DB100a", "5 Amp DCC Booster with Auto Reversing", 1994, .none, [.Booster], 0, 0),
    (.DB99, "DB99", "4.5 Amp DCC Booster", 1994, .none, [.Booster], 0, 0),
    ...
    (.DCS100, "DCS100", "5 Amp DCC Command Station & Booster", 1996, .none, [.CommandStation, .Booster, .Programmer], 0, 0),
    ...
    (.DB200PLUS, "DB200+", "8 Amp DCC Booster", 1998, .none, [.Booster], 0, 0),
    (.DT100R, "DT100R", "Advanced Radio Equipped Throttle", 1998, .none, [.Throttle, .SimplexRadioTransmitter], 0, 0),
    (.UR90, "UR90", "Infrared Receiver Front Panel", 1998, .none, [.IRPanel], 0, 0),
    (.UR91, "UR91", "Simplex Radio Equipped / IR Receiver Panel", 1998 , .none, [.SimplexRadioPanel], 0, 0),
    (.UT2, "UT2", "Utility Throttle", 1998, .none, [.Throttle], 0, 0),
    (.DCS200, "DCS200", "8 Amp DCC Command Station & Booster", 2000, .none, [.CommandStation, .Booster, .Programmer], 0, 0),
    (.DB150, "DB150", "5 Amp DCC Command Station/Booster with intelligent Auto Reverse", 1999, .none, [.CommandStation, .Booster], 0, 0),
    (.BDL16, "BDL16", "LocoNet Occupancy Detector, 16 Detection Sections", 2000, .none, [.OccupancyDetector], 0, 0),
    ...
    (.PM4, "PM4", "Power Manager", 2000, .none, [.PowerManager], 0, 0),
    (.BDL162, "BDL162", "LocoNet Occupancy Detector, 16 Detection Sections", 2002, .none, [.OccupancyDetector], 0, 0),
    (.PM42, "PM42", "Quad Power Manager", 2002, .none, [.PowerManager], 0, 0),
    (.SE8C, "SE8C", "Signal Decoder", 2003, .none, [.SignalDecoder], 0, 0),
    (.BDL168, "BDL168", "LocoNet Occupancy Detector, 16 Detection Sections", 2004, .none, [.OccupancyDetector], 0, 0),
    (.DB200OPTO, "DB200-OPTO", "OPTO 8 Amp DCC Opto Booster", 2006, .none, [.Booster], 0, 0),
    (.DCS50, "DCS50", "All-in-one Command Station / Booster / Throttle", 2006, .none, [.CommandStation, .Booster, .Throttle], 0, 0),
    ...
    (.UR92, "UR92", "Duplex Radio Transceiver / IR Receiver Panel", 2006, .UR92, [.DuplexRadioPanel], 0, 0),
    (.UR93, "UR93", "Duplex Radio Transceiver / IR Receiver Panel", 2006, .UR93, [.DuplexRadioPanel], 0, 0),
    (.UR93E, "UR93E", "Duplex Radio Transceiver / IR Receiver Panel", 2006, .UR93, [.DuplexRadioPanel], 0, 0),
    ...
    (.DS54, "DS54", " Quad Stationary Decoder with Programmable LocoNet Inputs & Outputs", 2006, .none, [.StationaryDecoder], 0, 0),
    (.DS64, "DS64", "Quad Stationary Decoder", 2006, .none, [.StationaryDecoder], 0, 0),
    (.LNRP, "LNRP", "Loconet Repeater Module", 2007, .LNRP, [.Repeater], 0, 0),
    (.PR3, "PR3", "SoundFX USB Decoder Programmer", 2008, .PR3, [.ComputerInterface, .LocoNetInterface, .Programmer], 0, 0),
    ...
    (.DCS51, "DCS51", "All-in-one Command Station / Booster / Throttle", 2010, .DCS51, [.CommandStation, .Booster, .Throttle], 0, 0),
    (.DT402DCE, "DT402DCE", "DCE Duplex Radio Equipped Super Throttle for Europe", 2011, .DT402, [.Throttle, .DuplexRadioTransceiver], 0, 0),
    (.UR92CE, "UR92CE", "Duplex Radio Transceiver / IR Receiver Panel for Europe", 2011, .UR92, [.DuplexRadioPanel], 0, 0),
    ...
    (.LNRPXTRA, "LNRPXTRA", "LocoNet Repeter Module", 2013, .none, [.Repeater], 0, 0),
    (.PR3XTRA, "PR3XTRA", "SoundFX USB Decoder Programmer", 2013, .none, [.ComputerInterface, .LocoNetInterface, .Programmer], 0, 0),
    (.DCS210, "DCS210", "5/8 Amp DCC Command Station & Booster", 2016, .DCS210, [.CommandStation, .Booster, .Programmer], 0, 0),
    (.DCS240, "DCS240", "5/8 Amp DCC Command Station & Booster", 2016, .DCS240, [.CommandStation, .Booster, .ComputerInterface, .LocoNetInterface, .Programmer], 0, 0),
    ...
    (.LNWI, "LNWI", "LocoNet WiFi Interface", 2017, .LNWI, [.WiFiPanel], 0, 0),
    (.PR4, "PR4", "SoundFX USB Decoder Programmer", 2017, .PR4, [.ComputerInterface, .LocoNetInterface, .Programmer], 0, 0),
    (.BXPA1, "BXPA1", "LocoNet DCC Auto-Reverser with Detection, Transponding and Power Management", 2018, .BXPA1, [.OccupancyDetector, .PowerManager, .Transponding], 0, 0),
    (.DCS52, "DCS52", "All-in-one Command Station / Booster / Throttle", 2019, .DCS52, [.CommandStation, .Booster, .Throttle], 0, 0),
    (.DCS210PLUS, "DCS210+", "DCC Command Station & Booster" , 2020, .DCS210Plus, [.CommandStation, .Booster, .ComputerInterface, .LocoNetInterface, .Programmer], 0, 0),
    ...
    (.DS74, "DS74", "Quad Switch Stationary Decoder", 2021, .DS74, [.StationaryDecoder], 0, 0),
    (.DS78V, "DS78V", "Eight Servo LocoNet Stationary & Accessory decoder for turnout control", 2021, .none, [.StationaryDecoder], 0, 0),
  ]
