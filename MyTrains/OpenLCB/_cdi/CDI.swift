...
enum CDI {
  ...
  static let UNIT_FREQUENCY             = "%%UNIT_FREQUENCY%%"
  static let UNIT_TEMPERATURE           = "%%UNIT_TEMPERATURE%%"
  static let UNIT_VOLTAGE               = "%%UNIT_VOLTAGE%%"
  static let UNIT_CURRENT               = "%%UNIT_CURRENT%%"
  ...
  static let ACTUAL_DISTANCE_UNITS      = "%%ACTUAL_DISTANCE_UNITS%%"
  ...
  static let VIEW_OPTIONS               = "%%VIEW_OPTIONS%%"
  static let VIEW_TYPES                 = "%%VIEW_TYPES%%"
}
