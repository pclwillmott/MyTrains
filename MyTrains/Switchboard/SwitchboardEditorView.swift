...
class SwitchboardEditorView: SwitchboardView {
  ...
  override func draw(_ dirtyRect: NSRect) {
    ...
    guard let switchboardPanel, let appLayoutId, let _ = appDelegate.networkLayer?.virtualNodeLookup[appLayoutId] as? LayoutNode, let switchboardItems = switchboardPanel.switchboardItems else {
      return
    }
  ...
  override func mouseUp(with event: NSEvent) {
    ...
    guard let switchboardPanel, let networkLayer = appDelegate.networkLayer, let switchboardItems = switchboardPanel.switchboardItems else {
      return
    }
