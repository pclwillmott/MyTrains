  ...
  public func save() {
    ...
    if modified {
      ...
      if primaryKey == -1 {
        ...
        "[\(NETWORK.LOCONET_DEVICE_ID)] = @\(NETWORK.LOCONET_DEVICE_ID), " +
      ...
      cmd.parameters.addWithValue(key: "@\(NETWORK.LOCONET_DEVICE_ID)", value: locoNetDeviceId)
