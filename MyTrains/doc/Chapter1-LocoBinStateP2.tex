\newpage
\subsection{LocoBinStateP2}\index{LocoBinStateP2}

\underline{Description:}

This \gls{Command} sets the locomotive's binary states with addresses in the range 1 to 32767. The address of 0 is a broadcast command and will set or reset all binary states.
