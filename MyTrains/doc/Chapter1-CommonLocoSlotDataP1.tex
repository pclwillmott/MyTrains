...
The consist top-member is the locomotive slot which controls the speed, direction and status of all members of a \gls{Universal Consist}. When a slot is uplinked the $<$SPD$>$ byte contains the slot number of the top-member. A mid-consist is a slot that is the top-member of another consist, i.e. a consist of consists.\index{Top-Member}\index{Mid-Consist} A downlinked slot is one which has another slot uplinked to it.
