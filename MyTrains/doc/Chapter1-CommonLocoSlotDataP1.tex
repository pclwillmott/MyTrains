...
d2 & 1 means this command station implements protocol 1 messages and 0 means the command station is a DT200.\\
d1 & 0 means the track is paused, broadcast an emergency stop.\\
d0 & 1 means the DCC packets are on in the command station and the track power is on.\\
\end{tabular}
