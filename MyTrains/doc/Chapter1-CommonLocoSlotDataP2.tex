...
\hline
\end{tabular}
& $<$SLOTL\#$>$ & Slot number in the range 0x00 to 0x77.\\
\end{tabular}
...
\begin{tabular}{p{0.05\linewidth} p{0.6\linewidth}} 
d6 & F8 state: 1 means on and 0 means off\\
d5 & F0 state: 1 means on and 0 means off\\
...
\begin{tabular}{p{0.05\linewidth} p{0.6\linewidth}} 
d6 & F7 state: 1 means on and 0 means off\\
d5 & F6 state: 1 means on and 0 means off\\
d4 & F5 state: 1 means on and 0 means off\\
