...
An IPL capable device sends this response in response to an \textbf{IPLDiscover} broadcast message.
...
\hline
\end{tabular}
& $<$D1$>$ & Product code low 7 bits.\\
\end{tabular}

\begin{tabular}{l l}
\underline{Product Code} & \underline{Device}\\
0x01 & LNRP\\
0x04 & UT4\\
0x0C & WTL12\\
0x14 & DB210 Opto\\
