\newpage
\subsection{LocoF5F11P2}\index{LocoF5F11P2}\index{Functions}

\underline{Description:}

This \gls{Command} requests the command station to set the locomotive's function F5 to F11 states.
