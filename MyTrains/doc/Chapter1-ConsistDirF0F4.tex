\newpage
\section{ConsistDirF0F4}\index{ConsistDirF0F4}\index{Consist}

\underline{Description:}

This \gls{Command} sets the consist element's direction and function F0 to F4 states.
...
\hline
\end{tabular}
& $<$DIRF$>$ & Consist element's direction and function F0 to F4 states.\\
& \\
\end{tabular}
