\newpage
\subsection{LocoDirF0F4V2}

\underline{Description:}

This command sets the locomotive's direction and function F0 to F4 states.
...
\hline
\end{tabular}
& 0x2$<$SLOTP$>$ & Bits d2 to d0 contain the slot page number in the range 0x0 to 0x7.\\
\end{tabular}
...
\hline
\end{tabular}
&  & Direction and function states.\\
\end{tabular}

\begin{tabular}{p{0.05\linewidth} p{0.95\linewidth}} 
d5 & Locomotive direction: 1 means forward and 0 means backwards.\\
