\newpage
\section{LocoF21F28P2}\index{LocoF21F28P2}\index{Functions}

\underline{Description:}

This \gls{Command} requests the command station to set the locomotive's function F21 to F28 states.
