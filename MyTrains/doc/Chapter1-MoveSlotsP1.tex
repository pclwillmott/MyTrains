\newpage
\section{MoveSlotsP1}\index{MoveSlotsP1}\index{Slot}\index{Null Move}
...
SRC & SRC & Null move. SRC is set to \gls{In-Use}.\\
SRC & DEST & Move slot data from SRC to DEST if not \gls{In-Use}. Clear SRC.\\
\end{tabular}
...
\textbf{LocoSlotDataP1} if successful, otherwise \textbf{IllegalMoveP1} 
