...
enum DEFAULT {
  ...
  // Programmer Tool Defaults
  
  static let PROGRAMMER_TOOL_CURRENT_INSPECTOR = "PROGRAMMER_TOOL_CURRENT_INSPECTOR"
  static let PROGRAMMER_TOOL_CURRENT_SELECTOR = "PROGRAMMER_TOOL_CURRENT_SELECTOR"
