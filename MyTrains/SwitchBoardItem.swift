...
public typealias RoutePart = (fromSwitchBoardItem: SwitchBoardItem, fromNodeId: Int, toSwitchBoardItem: SwitchBoardItem, toNodeId: Int, switchSettings: [TurnoutSwitchSetting], distance: Double)
