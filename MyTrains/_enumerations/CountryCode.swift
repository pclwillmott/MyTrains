...
public enum CountryCode : UInt16 {
  ...
  case iran            = 364
  case spain           = 724
  case greatBritain    = 826
  case northernIreland = 8261
  ...
  private static let titles : [CountryCode:String] = [
    ...
    .greatBritain    : String(localized: "Great Britain", comment: "This is the name of a country."),
    .northernIreland : String(localized: "Northern Ireland", comment: "This is the name of a country."),
  ]
