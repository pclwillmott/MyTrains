...
public typealias LocoNetDeviceAttributes = Set<DeviceAttribute>

public typealias LocoNetProduct = (id: DeviceId, productName: String, description: String, approxDate: Int, productCode: ProductCode, attributes: LocoNetDeviceAttributes, sensors: Int, switches: Int, manufacturer:Manufacturer, cvs: Int)
...
public class LocoNetProducts {
  ...
  private static let products : [LocoNetProduct] = [
    ...
    (.TowerLCC, "CS-105", "LCC Command Station & WiFi Access Point", 2022, .none, [.ComputerInterface, .LCC, .OpenLCBCANWifi], 0, 0, .trainControlSystems, 0),
  ]
  
  private static var _productDictionary : [DeviceId:LocoNetProduct]?
  
  // MARK: Class Public Properties
  
  public static var productDictionary : [DeviceId:LocoNetProduct] {
    ...
    get {
      ...
      var dictionary : [DeviceId:LocoNetProduct] = [:]
  ...
  public static func product(id: DeviceId) -> LocoNetProduct? {
  ...
  public static func computerInterfaces() -> [DeviceId:LocoNetProduct] {
    
    var result : [DeviceId:LocoNetProduct] = [:]
